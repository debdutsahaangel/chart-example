...
@JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    init {
        ...
        if (attrs != null) {
            ...
            val orientationOrdinal = typedArray?.getInt(R.styleable.DashedLine_orientation, Orientation.VERTICAL.ordinal)
                ?: Orientation.VERTICAL.ordinal
            orientation = if (orientationOrdinal == Orientation.VERTICAL.ordinal) {
